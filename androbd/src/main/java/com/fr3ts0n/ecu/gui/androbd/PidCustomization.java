...
public class PidCustomization
     ...
     *           but final display range is defined in physical (float) values, I
     *           decided to use raw values
     *           with item defined limits within SeekBars, but always display and
     *           return
