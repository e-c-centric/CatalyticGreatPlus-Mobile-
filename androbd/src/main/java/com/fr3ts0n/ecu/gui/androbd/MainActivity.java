...
public class MainActivity extends PluginManager
    ...
    private static final String TAG = "CatalyticGreat+";
    /**
     ...
     * This flag ist used to temporarily allow negative OBD responses without
    ...
    protected void onDestroy() {
        ...
        // Add a null check for CommService.elm
        if (CommService.elm != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.vehicle_manager:
                Intent carManagerIntent = new Intent(this, CarManagerActivity.class);
                startActivity(carManagerIntent);
                return true;

            case R.id.vehicle_health:
                Intent vehicleHealthIntent = new Intent(this, ViewVehicleHealthActivity.class);
                startActivity(vehicleHealthIntent);
                return true;
    ...
    private void checkToRestoreLastViewMode() {
        ...
        if (istRestoreWanted(PRESELECT.LAST_VIEW_MODE)) {
            ...
            DATA_VIEW_MODE lastMode = DATA_VIEW_MODE.valueOf(prefs.getString(PRESELECT.LAST_VIEW_MODE.toString(),
    ...
    private void setLogLevels() {
        // Always set logger main level to ALL, ignoring preferences
        MainActivity.rootLogger.setLevel(Level.ALL);
    }
    ...
    private void setObdService(int newObdService, CharSequence menuTitle) {
        ...
        switch (newObdService) {
            ...
            case ObdProt.OBD_SVC_PERMACODES:
            case ObdProt.OBD_SVC_READ_CODES:
                // NOT all DFC modes are supported by all vehicles, disable NRC handling for
                // this request
                ignoreNrcs = true;
