 ...
 * 
 */
public class KLHandlerGeneric extends SerialHandlerGeneric
	implements TelegramWriter
{
	...
	private static final int commTimeoutTime = 2000; // [ms]
	...
	private void writeChar(char txByte, boolean rememberTx)
	{
		try
		{
			...
			SerialExt.sendChar((byte) txByte);
	 ...
	 */
	private synchronized void init5Baud(int address)
	{
		int result = 0;
	...
	public static void main(String args[])
	{
		...
		KLHandlerGeneric hdlr = new KLHandlerGeneric(device);
